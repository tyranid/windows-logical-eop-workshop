...
boolean TestLoadLibraryCanonical( 
    /* [in] */ handle_t hBinding,
    /* [string] */ const wchar_t *name)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&RpcServer_StubDesc,
                  (PFORMAT_STRING) &server__MIDL_ProcFormatString.Format[40],
                  ( unsigned char * )&hBinding);
    return ( boolean  )_RetVal.Simple;
...
boolean TestLoadLibraryTocTou( 
    /* [in] */ handle_t hBinding,
    /* [string] */ const wchar_t *lib_path)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&RpcServer_StubDesc,
                  (PFORMAT_STRING) &server__MIDL_ProcFormatString.Format[80],
                  ( unsigned char * )&hBinding);
    return ( boolean  )_RetVal.Simple;
...
boolean TestLoadLibraryTocTouHardened( 
    handle_t hBinding,
    /* [string] */ const wchar_t *lib_path)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&RpcServer_StubDesc,
                  (PFORMAT_STRING) &server__MIDL_ProcFormatString.Format[120],
                  ( unsigned char * )&hBinding);
    return ( boolean  )_RetVal.Simple;
    ...
    /* [in] */ int handle)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&RpcServer_StubDesc,
                  (PFORMAT_STRING) &server__MIDL_ProcFormatString.Format[160],
                  ( unsigned char * )&hBinding);
    ...
    /* [in] */ handle_t hBinding)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&RpcServer_StubDesc,
                  (PFORMAT_STRING) &server__MIDL_ProcFormatString.Format[200],
                  ( unsigned char * )&hBinding);
    return ( boolean  )_RetVal.Simple;
